#!/bin/bash
#===============================================
# Description: OpenWrt_Build_2512_x64 DIY script part 1
...
if [ "$str1" = "5.4" ];then
   ...
   mv  bin/targets/x86/64/openwrt-x86-64-generic-squashfs-combined.img.gz       bin/targets/x86/64/openwrt_x86-64_${str1}.Others_bios.img.gz
   mv  bin/targets/x86/64/openwrt-x86-64-generic-squashfs-combined-efi.img.gz   bin/targets/x86/64/openwrt_x86-64_${str1}.Others_uefi.img.gz
   fi
fi
exit 0
EOF
